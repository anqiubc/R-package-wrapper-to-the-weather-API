...
6. Add more functions to get the time zone and sports events of a location.
...
## February 15, 2022
### What I did for the project:
Added unit tests to test the get_current_weather, get_time_zone, and get_sports_events functions

### Role in the bigger group picture:
Adding unit tests is important to ensure that the function works properly inside the weather api package.
